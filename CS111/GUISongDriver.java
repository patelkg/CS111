...
public class GUISongDriver extends JPanel implements ActionListener{
	...
	String [] names = {"Jai Sadguru Swami", "Bane Aaj Laal Laal", "Taro Chatak Rangeelo", "Me Nirakhya Sahajanand Dhanya Aaj Ni Gadhi", "Jamone Thaal Jivan", "Bolya Shree Hari Re "};
	int [] numberOfWriters = {1, 1, 1, 1, 1, 1};
	String [] writers = {"Sadguru Muktanand Swami", "Sadguru Premanand Swami", "Sadguru Brahmanand Swami", "Sadguru Brahmanand Swami", "Sadguru Bhumanand Swami", "Sadguru Premanand Swami", };
